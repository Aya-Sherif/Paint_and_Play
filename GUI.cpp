...
GUI::GUI()
{
	...
	StatusBarHeight = 50;
	ToolBarHeight = 60;
	MenuIconWidth = width/DRAW_ICON_COUNT;
	DrawColor = BLUE;	//default Drawing color
	FillColor =GREEN;	//default Filling color
	MsgColor = PINK;		//Messages color
...
operationType GUI::GetUseroperation() const
{
	...
	if (InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		if (y >= 0 && y < ToolBarHeight)
		{
			...
			case ICON_TRIANGEL: return DRAW_TRI;
...
void GUI::CreateDrawToolBar() 
{
	...
	MenuIconImages[ICON_TRIANGEL] = "images\\MenuIcons\\Menu_triangle.jpg";
	...
	MenuIconImages[ICON_COLOR_PALLETE] = "images\\MenuIcons\\color pallete.jpg";
	MenuIconImages[ICON_PEN_COLOR] = "images\\MenuIcons\\pen color.jpg";
	MenuIconImages[ICON_FILL_COLOR] = "images\\MenuIcons\\fill color.jpg";
	MenuIconImages[ICON_DELETE] = "images\\MenuIcons\\delete.jpg";
	MenuIconImages[ICON_SWITCH_MODE] = "images\\MenuIcons\\play mood.jpg";
	...
	for (int g = 0; g < DRAW_ICON_COUNT; g++)
		pWind->DrawLine((width/ DRAW_ICON_COUNT) * g, 0, (width / DRAW_ICON_COUNT) * g, ToolBarHeight);
}
//////////////////////////////////////////////////////////////////////////////////////////
...
////////////////_________________DRAWING_LINE____________________///////////////
...
//////////////////_____________________DRAWING_CIRCLR___________________//////////////////

void GUI::DrawCircle(Point P1, int Rad, GfxInfo CircleGfxInfo) const
{
	color DrawingClr;
...
//////////////////////////////////___________DRawing_TRIANGLe__________/////////////////////

void GUI::DrawTriangle(Point P1, Point P2,Point P3, GfxInfo LineGfxInfo) const
{
	color DrawingClr;
	if (LineGfxInfo.isSelected)	//shape is selected
		DrawingClr = HighlightColor; //shape should be drawn highlighted
...
/////////////////////////
//void GUI::DrawPolygon( Point P1, int Rad, GfxInfo PolygonGfxInfo) const
//{
//	color DrawingClr;
...
//		style = FRAME;
//
//	pWind->DrawPolygon(P1.x, P1.y, 5, style);
//
//}
//
