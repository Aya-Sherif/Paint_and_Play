...
public:
	...
	void DrawLine(Point P1, Point P2, GfxInfo RectGfxInfo) const;  //Draw a line
	void DrawCircle(Point P1, int Rad, GfxInfo RectGfxInfo) const;
	void DrawTriangle(Point P1, Point P2, Point P3, GfxInfo RectGfxInfo) const;
	void DrawPolygon (Point P1,int num, GfxInfo RectGfxInfo) const;
